...
export default function InquiryForm() {
  ...
  const copy = useTranslatedText(
    'We are not using an online inquiry backend yet. Please contact us directly for quotes, product requirements, private-label requests, and sourcing discussions.',
  )
  ...
  return (
    <div className="card-panel p-6 sm:p-8">
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-2">
        ...
        <div className="rounded-2xl border border-navy/8 bg-white/85 p-5">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-gold">{whatsappLabel}</p>
          <a
      ...
      <div className="mt-6 flex flex-wrap gap-4">
        <a href={`mailto:${activeSiteMeta.email}`} onClick={handleEmailClick} className="btn-primary w-40 text-center">
